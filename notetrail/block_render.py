...
class BlockRender:
    ...
    def convert_p_elem(self, p_node, children=None):
        return {
            "type": "paragraph",
            "paragraph": {
                "text": [{"type": "text", "text": {"content": p_node.text, "link": None}}],
                "children": children,
            },
        }
    ...
    def convert_ul_elem(self, convert_result: list, children=None):
        ...
        return {"type": "bulleted_list_item", "bulleted_list_item": {"text": convert_result}, "children": children}
    ...
    def convert_pre_elem(self, pre_node, children=None):
        ...
        return {
            "type": "code",
            "code": {
                "text": [{"type": "text", "text": {"content": code_node.text}}],
    ...
    def convert_code_elem(self, code_node, children=None):
        ...
        return {
            "type": "code",
            "code": {"text": [{"type": "text", "text": {"content": code_node.text}}], "language": "javascript"},
        }
